...
use esp_radio::wifi::{
    ClientConfig, ModeConfig, WifiController, WifiDevice, WifiEvent, WifiApState,
};
...
async fn connection(mut controller: WifiController<'static>) {
    ...
    loop {
        if matches!(esp_radio::wifi::wifi_state(), WifiApState::StaConnected) {
